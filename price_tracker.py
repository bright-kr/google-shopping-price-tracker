...
Info  : https://brightdata.co.kr/products/insights/price-tracker/google-shopping
"""
...
# https://brightdata.co.kr/products/web-scraper/google-shopping
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Google Shopping scraper at: https://brightdata.co.kr/products/web-scraper/google-shopping\n"
